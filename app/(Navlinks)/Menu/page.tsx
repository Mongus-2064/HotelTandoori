...
import React, { addTransitionType, useState } from 'react'
      ...
      >
        ...
        <section className='w-full  flex  gap-2 '>
          ...
          <div className='relative flex w-full items-center gap-2 flex-col lg:flex-row'>
            <p className='text-gray-600 absolute px-2'>

              {searchquery ? "": <Typewriter
            ...
            <div className='w-full flex flex-col lg:flex-row justify-center '>
              ...
              onChange={(e)=> setSearchQuery(e.target.value)}
               className='bg-gray-200 w-full py-2 rounded-md px-2 shadow-sm shadow-white' />
            </div>
        ...
        <section>
          ...
          >
                ...
                {filteredmenu.length === 0 &&(
                  <div className='bg-gray-500/40 gap-8  shadow-white shadow-md w-[95%]  lg:w-[50%] h-64 flex flex-col items-center justify-center'>
                    <Frown size={64} className='text-red-500'/>
                  <p className='text-white text-[20px] text-center'>Sorry, this item is currently unavailable at the moment</p>
